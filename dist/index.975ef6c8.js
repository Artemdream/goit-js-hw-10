...
var _fetchCountries = require("./API/fetchCountries");
...
function onSearch(e) {
    ...
    (0, _fetchCountries.fetchCountries)(inputSearchCountry).then((dataCountry)=>{
        console.log(dataCountry);
        if (dataCountry.length > 10) (0, _notiflixDefault.default).Notify.info("Too many matches found. Please enter a more specific name.");
...
},{"./css/styles.css":"1CY4s","lodash.debounce":"3JP5n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5z0Oc","./API/fetchCountries":"krxUS"}],"1CY4s":[function() {},{}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"krxUS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
